...
export const templateData: TemplateProps[] = [
  {
    ...
    imageUrls: {
      illustrations: [
        {
          src: "https://mfudfrexjmgxidwugcyw.supabase.co/storage/v1/object/public/templates/moderno/eCraft-template-1.webp",
    ...
    link: "https://eCraft-template-1.netlify.app",
    price: "4200 ₹",
    tags: ["Next.js", "ViewTransitions", "Seo Optimized", "Tailwind CSS"],
    rating: 4.8,
    seobility:
      "https://freetools.seobility.net/widget/widget.png?url=eCraft-template-1.netlify.app",
    colorSchema: [
    ...
    actions: {},
    full_description:
      "The eCraft website template is a modern, responsive solution designed for businesses and startups aiming to establish a strong online presence. It features a clean layout with smooth animations, intuitive navigation, and strategically placed call-to-action elements. Built with contemporary web technologies, this template ensures fast loading times and seamless performance across devices. Its versatile design makes it suitable for various industries, including tech, SaaS, and creative agencies. With customizable sections for services, portfolios, testimonials, and contact forms, the eCraft template provides a solid foundation for businesses to showcase their offerings and engage with their audience effectively",
    comingSoon: false,
  },
];
