        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Empowering entrepreneurs and traders with comprehensive E-commerce and Forex Trading education. Transform your career with our expert-led courses and practical training programs.
                </p>
                <div className="flex items-center">
                  ...
                  <a
                    href="https://www.linkedin.com/company/eCraft/"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              &copy;2025 eCraft.tech. All Rights Reserved | Empowering E-commerce & Trading Success
            </p>
          </div>
        </div>
