...
const Contact = () => {
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const calendlyUrl = `https://calendly.com/ecraft-tech14/30min?name=${encodeURIComponent(name)}&email=${encodeURIComponent(email)}&a1=${encodeURIComponent(message)}`;
          ...
          <div className="w-full px-4">
            ...
            >
              ...
              <p className="mb-12 text-base font-medium text-body-color">
                Get in touch with our e-commerce experts to discuss your marketplace growth strategy.
              </p>
                  ...
                  <div className="w-full px-4">
                    <div className="mb-8">
                      ...
                      <textarea
                        ...
                        rows={5}
                        required
                        placeholder="Tell us about your e-commerce goals and current challenges..."
